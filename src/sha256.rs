//! SHA-256 implemented from scratch, no external crates.
//!
//! Follows FIPS 180-4. Verified against the standard empty-string and "abc"
//! known-answer vectors in the unit tests below.
...
impl Sha256 {
    ...
    pub fn finalize(mut self) -> [u8; 32] {
        ...
        // append the 0x80 byte then pad with zeros to leave room for 8-byte length.
        let mut pad = [0u8; 72];
        pad[0] = 0x80;
    ...
    // update without touching total_len, used for padding bytes only.
